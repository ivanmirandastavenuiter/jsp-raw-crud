...
CREATE TABLE IF NOT EXISTS user (
    ...
    usNam VARCHAR(51) NOT NULL, 
    usSur VARCHAR(56),
    usUse VARCHAR(51) NOT NULL,
    usEma VARCHAR(71) NOT NULL,
    usPho VARCHAR(10) NOT NULL,
    usPas VARCHAR(255) NOT NULL,
...
-- Creation of cipher table
CREATE TABLE IF NOT EXISTS cipher (
    ciKey VARCHAR (255) NOT NULL,
    ciVec VARCHAR (255) NOT NULL,
    usId SMALLINT NOT NULL,
    CONSTRAINT PK_cipher PRIMARY KEY (ciKey, ciVec),
    CONSTRAINT FK_usId_cipher_table FOREIGN KEY (usId) REFERENCES user(usId) -- One user - many votes
);